...
- [ ] 1.1 Add essential linter: `staticcheck`
...
- [ ] 1.8 Add architecture linter: `depguard` with domain purity rule
- [ ] 1.9 Configure test file exclusions for complexity linters
- [ ] 1.10 Configure wrapcheck to ignore domain/errors packages
...
- [ ] 2.4 Fix all gocyclo/gocognit errors (refactor complex functions)
- [ ] 2.5 Fix all funlen errors (split long functions)
- [ ] 2.6 Fix all errorlint errors
- [ ] 2.7 Fix all wrapcheck errors
- [ ] 2.8 Fix all gosec errors or add justified exclusions
- [ ] 2.9 Fix all testifylint errors
- [ ] 2.10 Fix all other linter errors
- [ ] 2.11 Verify `golangci-lint run` passes cleanly
