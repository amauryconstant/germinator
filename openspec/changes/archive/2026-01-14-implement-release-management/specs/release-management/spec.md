...
## Purpose
Enable professional-grade release automation using GoReleaser for cross-platform builds, archives, checksums, SBOMs, and GitLab releases. Provide industry-standard release artifacts and one-line installation.
