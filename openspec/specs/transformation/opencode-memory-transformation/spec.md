# opencode-memory-transformation Specification

## Purpose
Transformation logic for converting Memory models from Germinator source format to OpenCode AGENTS.md format.
