# opencode-command-transformation Specification

## Purpose
Transformation logic for converting Command models from Germinator source format to OpenCode target format.
